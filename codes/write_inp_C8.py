...
def mysql2inp_C8(INPname, DBname):
    ...
    files.write('*Element, type=C3D8RH\n')
    ...
    try:
        ...
        results = cursor.fetchall()
        for row in results:
            [label, n1, n2, n3, n4, n5, n6, n7, n8] = row
            files.write(str('%d, %d, %d, %d, %d, %d, %d, %d, %d'
...
print 'IMPORT write_inp_C8 Success!'
